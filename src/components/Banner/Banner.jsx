      ...
      <div className="hero-content text-center flex-col">
        <div>
          <TypeAnimation
            ...
            wrapper="span"
            speed={50}
            className="text-3xl lg:text-8xl font-bold leading-tight block min-h-48"
            repeat={Infinity}
          />
        </div>
        <div>
          ...
          <button className="btn btn-outline font-bold text-white bg-gradient-to-r from-blue-600 to-violet-600 transition-all duration-700 ease-in-out hover:scale-105  sm:btn-sm md:btn-md lg:btn-wide">
            Get Started
          </button>
        </div>
      </div>
